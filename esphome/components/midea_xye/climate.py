...
StaticPressureNumber = midea_ac_ns.class_(
    "StaticPressureNumber", number.Number, cg.Component
)
    ...
    .extend(
        {
            ...
            cv.Optional(CONF_STATIC_PRESSURE): number.number_schema(
                StaticPressureNumber
            ).extend(
                {
